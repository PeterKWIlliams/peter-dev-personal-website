...
export default function WelcomeMessage() {
  return (
    <div className="relative mb-6 mt-24 flex flex-1 flex-col items-center justify-center">
      <div className=" flex flex-col space-y-10">
        <p className="text-3xl text-black">Hi,I am</p>
        <div className="space-y-2">
          <p className="text-5xl text-black">Peter Williams</p>
